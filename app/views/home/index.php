<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="blue" id="cart1" class="bi bi-cart" viewBox="0 0 16 16">
    <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5M3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4m7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2m7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2" />
  </symbol>
  <symbol xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="blue" id="quality1" class="bowtie" viewBox="0 0 16 16">
    <path d="M9.669.864 8 0 6.331.864l-1.858.282-.842 1.68-1.337 1.32L2.6 6l-.306 1.854 1.337 1.32.842 1.68 1.858.282L8 12l1.669-.864 1.858-.282.842-1.68 1.337-1.32L13.4 6l.306-1.854-1.337-1.32-.842-1.68L9.669.864zm1.196 1.193.684 1.365 1.086 1.072L12.387 6l.248 1.506-1.086 1.072-.684 1.365-1.51.229L8 10.874l-1.355-.702-1.51-.229-.684-1.365-1.086-1.072L3.614 6l-.25-1.506 1.087-1.072.684-1.365 1.51-.229L8 1.126l1.356.702 1.509.229z" />
    <path d="M4 11.794V16l4-1 4 1v-4.206l-2.018.306L8 13.126 6.018 12.1 4 11.794z" />
  </symbol>
  <symbol xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="blue" id="price-tag" viewBox="0 0 16 16">
                ...
                <li class="pe-3 mt-1">
                  <div class="dropdown text-end">
                    ...
                    <ul class="dropdown-menu text-small">
                      ...
                      <li>
                        <a class="dropdown-item" href="<?= BASEURL; ?>home/logout">
                          Log out
                        </a>
                      </li>
                    </ul>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?= BASEURL; ?>home/signup" method="post">
...
<section id="billboard" style="background-color: #EDF1F3; margin-top: 70px;">
  <div class="container">
    <div class="row d-flex align-items-center">
      <div class="col-md-6">
        <h1 class="display-2 text-uppercase text-dark pb-5">Your products are perfect for kids of all ages</h1>
        <a href="<?= BASEURL; ?>shop" class="btn btn-medium btn-dark text-uppercase btn-rounded-none">Shop Product</a>
      </div>
      <div class="col-md-5">
        <div class="ms-5 ps-5">
          <img src="<?= BASEURL; ?>images/billboard.png" alt="banner">
        </div>
      </div>
    </div>
  </div>
...
<section id="company-services" class="pt-5 mt-5">
  <div class="container center">
    <div class="row center">
      <div class="col-lg-4 col-md-6 pb-3">
        <div class="icon-box d-flex">
          <div class="icon-box-icon pe-3 pb-3">
            <svg class="bi bi-cart">
...
<section id="about-us" class="pt-5 mt-5">
  <div class="container">
...
<section id="mobile-products" class="product-store position-relative padding-large pt-5 mt-5">
  <div class="container">
    <div class="row">
      <div class="display-header d-flex justify-content-between pb-3">
        <h2 class="display-7 text-dark text-uppercase">Products</h2>
        <div class="btn-right">
          <a href="<?= BASEURL; ?>shop" class="btn btn-medium btn-normal text-uppercase">Go to Shop</a>
        </div>
      </div>
      <div class="swiper product-swiper">
        <div class="swiper-wrapper">
          <?php foreach ($data['products'] as $product) : ?>
            <div class="swiper-slide">
              <div class="card d-inline-block m-3" style="width: 18rem; height: 450px;">
                <img src="<?= BASEURL; ?>images/product/<?= $product['image'] ?>" class="card-img-top" style="width: 275px; height: 275px;" alt="Gambar <?= $product['name_product'] ?>">
                <div class="card-body">
                  <h5 class="card-title"><?= $product['name_product'] ?></h5>
                  <p class="card-text"><?= "Rp" . number_format($product['price'], 2, ",", "."); ?></p>
                  <a href="<?= BASEURL; ?>singleProduct/index/<?= $product['id_product'] ?>" class="btn btn-primary mt-auto btn-go-to-product">Go To Product</a>
                </div>
              </div>
            </div>
          <?php endforeach; ?>
        ...
        <br><br>
        <div class="swiper-pagination position-absolute text-center" style="bottom: 20px;"></div>
      </div>
    </div>
  </div>
</section>
