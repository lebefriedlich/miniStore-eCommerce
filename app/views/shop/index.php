                ...
                <li class="pe-3 mt-1">
                  <div class="dropdown text-end">
                    ...
                    <ul class="dropdown-menu text-small">
                      ...
                      <li>
                        <a class="dropdown-item" href="<?= BASEURL; ?>shop/logout">
                          Log out
                        </a>
                      </li>
                    </ul>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?= BASEURL; ?>shop/login" method="post">
          <ul>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?= BASEURL; ?>shop/signup" method="post">
      ...
      <main class="col-md-12">
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            <li class="page-item">
              <a class="page-link" href="<?= BASEURL; ?>shop/page/<?= $data['prevPage'] ?>" aria-label="Previous">
                <span aria-hidden="true">&laquo;</span>
              </a>
            </li>
            <?php for ($i = 1; $i <= $data["pagination"]; $i++) : ?>
              <li class="page-item">
                <a class="page-link" href="<?= BASEURL; ?>shop/page/<?= $i ?>"><?= $i; ?></a>
              </li>
            <?php endfor; ?>
            <li class="page-item">
              <a class="page-link" href="<?= BASEURL; ?>shop/page/<?= $data['nextPage'] ?>" aria-label="Next">
